...
@bp.route("/")
def home():
    # Render the home page template and pass the current page name
    return render_template("pages/home.html", current_page="home")

# Route for the contact page
@bp.route("/contact")
def contact():
    # Render the contact page template and pass the current page name
    return render_template("pages/contact.html", current_page="contact")

# Route for the projects page
@bp.route("/projects")
def projects():
    # Render the projects page template and pass the current page name
